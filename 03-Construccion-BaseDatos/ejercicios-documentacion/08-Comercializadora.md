...
CREATE TABLE oficina(
	...
	CHECK (region IN ('Norte', 'Sur', 'Este', 'Oeste'))

);
GO

/*==== SE AGREGARON EL CONSTRAINT UNIQUE PARA EL CAMPO CIUDAD ====*/
ALTER TABLE oficina
ADD CONSTRAINT 
uq_oficina_ciudad
UNIQUE(ciudad);
...
/*===== CREAR TABLA REPRESENTANTE ===== */ --forma 3
...
ALTER TABLE oficina
ADD CONSTRAINT fk_oficina_representant
